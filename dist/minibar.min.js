...
return{scrollTop:a.scrollTop,scrollLeft:a.scrollLeft,scrollHeight:a.scrollHeight,scrollWidth:a.scrollWidth,offsetWidth:a.offsetWidth,offsetHeight:a.offsetHeight,containerRect:this.rect,barSize:this.size}};l.scrollTo=function(a,b){b=b||"y";var c=this.getData(),d;"string"===typeof a?"start"===a?d=-c[n[b]]:"end"===a&&(d=c[r[b]]-c[C[b]]-c[n[b]]):d=a-c[n[b]];this.scrollBy(d,b)};l.scrollBy=function(a,b,c,d){b=b||"y";if(0===c)this.content[n[b]]+=a;else{void 0===c&&(c=250);d=d||function(a,b,c,d){a/=d;return-c*
a*(a-2)+b};var e=this,f=Date.now(),h=e.content[n[b]],k=function(){var g=Date.now()-f;g>c?(y(e.frame),e.content[n[b]]=Math.ceil(h+a)):(e.content[n[b]]=Math.ceil(d(g,h,a,c)),e.frame=w(k))};e.frame=k()}};l.wheel=function(a){a.preventDefault();this.scrollBy(100*a.deltaY,"x")};l.mouseenter=function(a){this.updateBars()};l.mousedown=function(a){a.preventDefault();var b=this.config,c=a.target===this["progress"===b.barType?"tracks":"bars"].x.node?"x":"y";if(d.classList.contains(a.target,"mb-track"))return b=
this.tracks[c],this.scrollTo((a[x[c]]-b[c])/b[p[c]]*(this.content[r[c]]-this.rect[p[c]]));this.down=!0;this.currentAxis=c;this.update();d.classList.add(this.container,b.classes.visible);d.classList.add(this.container,b.classes.scrolling+"-"+c);"progress"===b.barType?(this.origin={x:a.pageX-this.tracks[c].x,y:a.pageY-this.tracks[c].y},this.mousemove(a)):this.origin={x:a.pageX-this.bars[c].x,y:a.pageY-this.bars[c].y};d.on(k,"mousemove",this.events.mousemove);d.on(k,"mouseup",this.events.mouseup)};l.mousemove=
function(a){a.preventDefault();var b=this,c=this.origin,d=this.currentAxis,g=b.tracks[d],f="progress"===b.config.barType;a=(f?a[x[d]]-g[d]:a[x[d]]-c[d]-g[d])/g[p[d]];var h=f?a*(b.content[r[d]]-b.rect[p[d]]):a*b[r[d]];w(function(){b.content[n[d]]=h})};l.mouseup=function(a){var b=this.config,c=this.events;d.classList.toggle(this.container,b.classes.visible,b.alwaysShowBars);d.classList.remove(this.container,b.classes.scrolling+"-"+this.currentAxis);d.classList.contains(a.target,b.classes.bar)||(d.classList.remove(this.container,
b.classes.hover+"-x"),d.classList.remove(this.container,b.classes.hover+"-y"));this.currentAxis=null;this.down=!1;d.off(k,"mousemove",c.mousemove);d.off(k,"mouseup",c.mouseup)};l.update=function(){var a=this,b=a.config,c=a.content,e=a.size;a.rect=d.rect(a.container);a.scrollTop=c.scrollTop;a.scrollLeft=c.scrollLeft;a.scrollHeight=c.scrollHeight;a.scrollWidth=c.scrollWidth;a.offsetWidth=c.offsetWidth;a.offsetHeight=c.offsetHeight;a.clientWidth=c.clientWidth;a.clientHeight=c.clientHeight;var g=a.scrollWidth>
a.offsetWidth&&!a.textarea,f=a.scrollHeight>a.offsetHeight;d.classList.toggle(a.container,"mb-scroll-x",g&&b.scrollX&&!b.hideBars);d.classList.toggle(a.container,"mb-scroll-y",f&&b.scrollY&&!b.hideBars);d.css(c,{overflowX:g?"auto":"",overflowY:f?"auto":"",marginBottom:g?-e:"",paddingBottom:g?e:"",marginRight:f?-e:"",paddingRight:f&&!b.hideBars?e:""});a.scrollX=g;a.scrollY=f;q(a.tracks,function(b,c){v(c,d.rect(c.node));v(a.bars[b],d.rect(a.bars[b].node))});a.updateBars();a.wrapperPadding=0;a.textarea&&
(b=d.css(a.wrapper),a.wrapperPadding=parseInt(b.paddingTop,10)+parseInt(b.paddingBottom,10),!a.down&&a.content.selectionStart>=a.content.value.length&&(a.content.scrollTop=a.scrollHeight+1E3));this.config.onUpdate.call(this,this.getData())};l.updateBar=function(a){var b=this,c={},e=b.config,g=b.tracks[a][p[a]],f=b.rect[p[a]]-b.wrapperPadding,h=g/b[r[a]],k=b.content[n[a]]/(b[r[a]]-f);"progress"===e.barType?c[p[a]]=Math.floor(g*k):(c[p[a]]=Math.max(Math.floor(h*f),e.minBarSize),c[B[a]]=Math.floor((g-
c[p[a]])*k));w(function(){d.css(b.bars[a].node,c)})};l.updateBars=function(){q(this.bars,function(a,b){this.updateBar(a)},this)};l.destroy=function(){var a=this.config,b=this.container;if(this.initialised){d.off(b,"mouseenter",this.events.mouseenter);d.off(h,"resize",this.events.debounce);d.classList.remove(b,a.classes.visible);d.classList.remove(b,a.classes.container);d.classList.remove(b,a.classes.nav);for(q(this.tracks,function(c,e){b.removeChild(a.navButtons?e.node.parentNode:e.node);d.classList.remove(b,
"mb-scroll-"+c)});this.content.firstChild;)b.appendChild(this.content.firstChild);b.removeChild(this.content);this.manualPosition&&(b.style.position="");this.bars={x:{},y:{}};this.tracks={x:{},y:{}};this.content=null;this.mutationObserver&&(this.mutationObserver.disconnect(),this.mutationObserver=!1);a.observableItems&&(this.intersectionObserver&&(this.intersectionObserver.disconnect(),this.intersectionObserver=!1),q(this.items,function(b,e){var c=e.node||e;d.classList.remove(c,a.classes.item);d.classList.remove(c,
a.classes.itemVisible);d.classList.remove(c,a.classes.itemPartial);d.classList.remove(c,a.classes.itemHidden)}));this.initialised=!1}};m.MiniBar=t})(this);